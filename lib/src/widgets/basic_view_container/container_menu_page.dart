...
class ContainerMenuPage extends StatelessWidget {
  ...
  final BuildContext contextCurrentView; // if
  final GlobalKey<ScaffoldState>? globalScaffoldKey;// it true than
  ...
  const ContainerMenuPage({
    ...
    this.backgroundColor, this.globalScaffoldKey,
  }) : super(key: key);
    ...
    Widget returnSubMainView(
      ...
      return LayoutBuilder(
        builder: (BuildContext context, BoxConstraints viewportConstraints) {
          return isListScrollingNeed?ConstrainedBox(
...
class AppBarViewContainerManPage extends StatelessWidget {
  ...
  const AppBarViewContainerManPage(
      {Key? key, this.appBarHeight = 0, this.appBar, this.leading, this.tittle})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
