...
class ContainerFirst extends StatelessWidget {
  ...
  const ContainerFirst({
    ...
    this.appBackgroundColor = const Color(0xfff5f2f1),
    this.statusBarColor = const Color(0xfff5f2f1),
        ...
        builder: (BuildContext context, BoxConstraints viewportConstraints) {
          return
            Stack(
              fit: StackFit.expand,
              children: [
                isListScrollingNeed?ConstrainedBox(
                  constraints: BoxConstraints(
                    minHeight: remainingViewFullHeight > 0
                        ? remainingViewFullHeight
                        : viewportConstraints.minHeight,
                  ),
                  child: Container(color:appBackgroundColor,child: containChild)/*IntrinsicHeight(child: Container(color:appBackgroundColor,child: containChild))*/,
