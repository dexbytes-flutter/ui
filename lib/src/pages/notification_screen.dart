...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Expansible message container
    Widget expansibleMessageContainerTile(){
      return ListView.builder(
        key: Key("${selectedIndex.toString()}"),
        shrinkWrap: true,
        padding: EdgeInsets.only(bottom: 50),
        physics: ClampingScrollPhysics(),
        itemCount: notificationInfoList1.length,
        itemBuilder: (context,index){
          String title = notificationInfoList1[index].title ?? "";
          String notificationTime = notificationInfoList1[index].notificationTime ?? "";
          String descriptions = notificationInfoList1[index].descriptions ?? "";
          bool selected = selectedIndex == index;
    ...
    return ContainerFirst(
        ...
        containChild: Column(
          ...
          children: [
            ...
            // ),
            // expansibleMessageContainerTile(),
            // SizedBox(height: 20,),
          ],
        )
    );
